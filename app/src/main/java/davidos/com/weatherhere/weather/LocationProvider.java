...
public class LocationProvider extends AppCompatActivity implements
            ...
            public void onResult(@NonNull LocationSettingsResult locationSettingsResult) {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                        ...
                        Toast.makeText(mContext, "Please activate location services in settings", Toast.LENGTH_LONG).show();
                        break;
                }
            }
        });
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        if (connectionResult.hasResolution() && mContext instanceof Activity) {
             ...
             * user with the error.
             */
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog((Activity) mContext, connectionResult.getErrorCode(), 69);
            dialog.show();
